...
int main(void)
{
    ...
    printf("\nTry and guess the secret code.  An \"O\" means your number is correct, a \"+\" means the number is in the secret code, but in the incorrect spot, and an \"X\" means it is incorrect.\n");
